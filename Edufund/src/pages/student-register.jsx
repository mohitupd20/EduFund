        ...
        <div className="md:flex">
          <div className="md:w-1/2 bg-indigo-600 p-8 text-white flex flex-col justify-center">
            ...
            <p className="text-indigo-200 mb-6">
              Join our platform to connect with donors who can help fund your
              education and achieve your academic goals.
            </p>
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span>Connect with generous donors</span>
              </div>
              <div className="flex items-center">
                <div className="bg-indigo-500 rounded-full p-2 mr-3">
                  <svg
                ...
                <span>Share your academic journey</span>
              </div>
              <div className="flex items-center">
                <div className="bg-indigo-500 rounded-full p-2 mr-3">
                  <svg
                ...
                <span>Receive financial support for your education</span>
              </div>
            </div>
          </div>
